export const projects = [
  {
    ...
    image: './assets/p-TAPESTRY-landing.png',
    repositoryLink: 'https://github.com/kangcarol/tapestry',
    deploymentLink: 'https://carolkang-tapestry-app.fly.dev/',
  },
  {
    title: 'The Phoenix',
    description: 'Choose Your Own Adventure game based on the mythological Phoenix, built with Javascript, HTML, CSS',
    image: './assets/p-THE-PHOENIX-landing.png',
