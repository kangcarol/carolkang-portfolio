export const projects = [
  {
    ...
    objective: "The Botanist's Library was a fullstack reference app, built with one-to-many and many-to-many relationships.",
  ...
  },
  {
    ...
    timeline: 'Project completed in one week',
    objective: 'Tapestry is a MEN stack app, the technical requirements included at least one entity besides the profile, Tapestry was built with three.',
  ...
  },
  {
    ...
    timeline: 'Project completed in one week',
    objective: 'The Phoenix was my first independent project. Technical requirement was to use win/lose logic.  It utilized conditional statements, DOM manipulation, CSS flex and grid features.',
